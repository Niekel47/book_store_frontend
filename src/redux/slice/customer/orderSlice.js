...
export const addOrder = createAsyncThunk(
  ...
  async (data_order, { rejectWithValue }) => {
    try {
      const res = await axios.post(URL_API + `order`, data_order, {
...
export const getOrderWait = createAsyncThunk(
  ...
  async (user_id) => {
    try {
      const res = await axios.get(URL_API + `order/order_wait/${user_id}`, {
        withCredentials: true,
      });
...
export const getOrderShip = createAsyncThunk(
  ...
  async (user_id) => {
    try {
      const res = await axios.get(URL_API + `order/order_ship/${user_id}`, {
        withCredentials: true,
      });
      return res.data.orders;
    } catch (error) {
...
export const getOrderComplete = createAsyncThunk(
  ...
  async (user_id) => {
    try {
      const res = await axios.get(URL_API + `order/order_complete/${user_id}`, {
        withCredentials: true,
      });
      return res.data;
    } catch (error) {
...
export const getOrderCancel = createAsyncThunk(
  ...
  async (user_id) => {
    try {
      const res = await axios.get(URL_API + `order/order_cancel/${user_id}`, {
        withCredentials: true,
      });
      return res.data.orders;
    } catch (error) {
  ...
  async (order_id) => {
    try {
      const res = await axios.put(
        URL_API + `order/order_cancel_action/${order_id}`,
        {
          withCredentials: true,
        }
      );
...
export const orderConfirmAction = createAsyncThunk(
  ...
  async (order_id) => {
    try {
      const res = await axios.put(
        URL_API + `order/order_confirm_action/${order_id}`,
        {
          withCredentials: true,
        }
      );
