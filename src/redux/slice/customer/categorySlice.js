  ...
  extraReducers: (builder) => {
    builder
      .addCase(fetchAllCategory.pending, (state, action) => {
        ...
        state.listCategorySkincare = [];
        state.listCategoryMakeup = [];
        state.isError = false;
      })
      .addCase(fetchAllCategory.fulfilled, (state, action) => {
        state.listCategorySkincare = action.payload.category_skincare;
        state.listCategoryMakeup = action.payload.category_makeup;
